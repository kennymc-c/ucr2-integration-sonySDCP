...
def create_ui_pages() -> list[ucapi.ui.UiPage | dict[str, Any]]:
    ...
    ui_page4.add(ucapi.ui.create_ui_text("1,85", 0, 1, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("PICTURE_POSITION_1_85")))
    ui_page4.add(ucapi.ui.create_ui_text("2,35", 2, 1, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("PICTURE_POSITION_2_35")))
    ui_page4.add(ucapi.ui.create_ui_text("Custom 1", 0, 2, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("PICTURE_POSITION_CUSTOM_1")))
    ui_page4.add(ucapi.ui.create_ui_text("Custom 2", 2, 2, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("PICTURE_POSITION_CUSTOM_2")))
    ui_page4.add(ucapi.ui.create_ui_text("Custom 3", 0, 3, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("PICTURE_POSITION_CUSTOM_3")))
    ui_page4.add(ucapi.ui.create_ui_text("Custom 4", 2, 3, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("PICTURE_POSITION_CUSTOM_4")))
    ui_page4.add(ucapi.ui.create_ui_text("Custom 5", 1, 4, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("PICTURE_POSITION_CUSTOM_5")))

    ui_page5 = ucapi.ui.UiPage("page5", "Motionflow")
    ui_page5.add(ucapi.ui.create_ui_text("-- Motionflow --", 0, 0, size=ucapi.ui.Size(4, 1)))
    ui_page5.add(ucapi.ui.create_ui_text("Off", 0, 1, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("MODE_MOTIONFLOW_OFF")))
    ui_page5.add(ucapi.ui.create_ui_text("True Cinema", 2, 1, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("MODE_MOTIONFLOW_TRUE_CINEMA")))
    ui_page5.add(ucapi.ui.create_ui_text("Smoth High", 0, 2, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("MODE_MOTIONFLOW_SMOTH_HIGH")))
    ui_page5.add(ucapi.ui.create_ui_text("Smoth Low", 2, 2, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("MODE_MOTIONFLOW_SMOTH_LOW")))
    ui_page5.add(ucapi.ui.create_ui_text("Impulse", 0, 3, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("MODE_MOTIONFLOW_IMPULSE")))
    ui_page5.add(ucapi.ui.create_ui_text("Combination", 2, 3, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("MODE_MOTIONFLOW_COMBINATION")))
    ...
    ui_page6.add(ucapi.ui.create_ui_text("2D", 0, 1, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("MODE_2D_3D_SELECT_2D")))
    ui_page6.add(ucapi.ui.create_ui_text("3D", 2, 1, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("MODE_2D_3D_SELECT_3D")))
    ui_page6.add(ucapi.ui.create_ui_text("Auto", 4, 1, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("MODE_2D_3D_SELECT_AUTO")))
    ui_page6.add(ucapi.ui.create_ui_text("-- 3D Format --", 0, 2, size=ucapi.ui.Size(6, 1)))
    ui_page6.add(ucapi.ui.create_ui_text("Simulated 3D", 0, 3, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("MODE_3D_FORMAT_SIMULATED_3D")))
    ui_page6.add(ucapi.ui.create_ui_text("Side-by-Side", 2, 3, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("MODE_3D_FORMAT_SIDE_BY_SIDE")))
    ui_page6.add(ucapi.ui.create_ui_text("Over-Under", 4, 3, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("MODE_3D_FORMAT_OVER_UNDER")))
    ...
    ui_page7.add(ucapi.ui.create_ui_icon("uc:up-arrow", 0, 2, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("LENS_FOCUS_NEAR")))
    ui_page7.add(ucapi.ui.create_ui_icon("uc:down-arrow", 0, 3, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("LENS_FOCUS_FAR")))
    ui_page7.add(ucapi.ui.create_ui_icon("uc:up-arrow-bold", 2, 2, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("LENS_ZOOM_LARGE")))
    ui_page7.add(ucapi.ui.create_ui_icon("uc:down-arrow-bold", 2, 3, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("LENS_ZOOM_SMALL")))
    ui_page7.add(ucapi.ui.create_ui_icon("uc:up-arrow-alt", 1, 4, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("LENS_SHIFT_UP")))
    ui_page7.add(ucapi.ui.create_ui_icon("uc:left-arrow-alt", 0, 5, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("LENS_SHIFT_LEFT")))
    ui_page7.add(ucapi.ui.create_ui_icon("uc:right-arrow-alt", 2, 5, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("LENS_SHIFT_RIGHT")))
    ui_page7.add(ucapi.ui.create_ui_icon("uc:down-arrow-alt", 1, 6, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("LENS_SHIFT_DOWN")))

    ui_page8 = ucapi.ui.UiPage("page8", "Miscellaneous", grid=ucapi.ui.Size(6, 8))
    ui_page8.add(ucapi.ui.create_ui_text("-- Lamp Control --", 0, 0, size=ucapi.ui.Size(6, 1)))
    ui_page8.add(ucapi.ui.create_ui_text("High", 0, 1, size=ucapi.ui.Size(3, 1), cmd=ucapi.remote.create_send_cmd("LAMP_CONTROL_HIGH")))
    ui_page8.add(ucapi.ui.create_ui_text("Low", 3, 1, size=ucapi.ui.Size(3, 1), cmd=ucapi.remote.create_send_cmd("LAMP_CONTROL_LOW")))
    ui_page8.add(ucapi.ui.create_ui_text("-- Advanced Iris --", 0, 2, size=ucapi.ui.Size(6, 1)))
    ui_page8.add(ucapi.ui.create_ui_text("Off", 0, 3, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("MODE_ADVANCED_IRIS_OFF")))
    ui_page8.add(ucapi.ui.create_ui_text("Full", 2, 3, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("MODE_ADVANCED_IRIS_FULL")))
    ui_page8.add(ucapi.ui.create_ui_text("Limited", 4, 3, size=ucapi.ui.Size(2, 1), cmd=ucapi.remote.create_send_cmd("MODE_ADVANCED_IRIS_LIMITED")))
    ui_page8.add(ucapi.ui.create_ui_text("-- Input Lag Reduction --", 0, 4, size=ucapi.ui.Size(6, 1)))
    ui_page8.add(ucapi.ui.create_ui_text("On", 0, 5, size=ucapi.ui.Size(3, 1), cmd=ucapi.remote.create_send_cmd("INPUT_LAG_REDUCTION_ON")))
    ui_page8.add(ucapi.ui.create_ui_text("Off", 3, 5, size=ucapi.ui.Size(3, 1), cmd=ucapi.remote.create_send_cmd("INPUT_LAG_REDUCTION_OFF")))
    ui_page8.add(ucapi.ui.create_ui_text("-- Menu Position --", 0, 6, size=ucapi.ui.Size(6, 1)))
    ui_page8.add(ucapi.ui.create_ui_text("Bottom Left", 0, 7, size=ucapi.ui.Size(3, 1), cmd=ucapi.remote.create_send_cmd("MENU_POSITION_BOTTOM_LEFT")))
    ui_page8.add(ucapi.ui.create_ui_text("Center", 3, 7, size=ucapi.ui.Size(3, 1), cmd=ucapi.remote.create_send_cmd("MENU_POSITION_CENTER")))

    return [ui_page1, ui_page2, ui_page3, ui_page4, ui_page5, ui_page6, ui_page7, ui_page8]
